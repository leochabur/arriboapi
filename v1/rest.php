...
function echoResponse($status_code, $response) {
    ...
    //$app->response->headers->set("Access-Control-Allow-Origin", "http://localhost:3000");
    //$app->response->headers->set("Access-Control-Allow-Methods", "HEAD, GET, POST, PUT, PATCH, DELETE, OPTIONS");
